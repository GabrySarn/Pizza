...
public class PizzaGui extends JFrame {
    ...
    public PizzaGui(String richiesta, String ing, int num,String scontrino) {
        ...
        for (int i = 0; i < ing.size(); i++) {
            ...
            btn.get(i).addActionListener(e -> {
                if (selected.contains(e.getActionCommand())) {
                    ...
                    result = writePizza(listaPizze, selected);
                    if (result == null) {
                        JOptionPane.showMessageDialog(this, "Pizza non disponibile"); // messaggio di controllo
                        selected = "Pizza";
                        lblImg.setIcon(null);
                    } else {
                        lblImg.setIcon(new ImageIcon("img\\Pizze\\" + result + ".png"));
                    }
                }
            });
        }
    ...
    public String writePizza(ArrayList<String> pizze, String ingredients) {
